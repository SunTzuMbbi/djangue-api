  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.topBar}>
        ...
        <Text style={styles.title}>Demo de la app</Text>
        <View style={{ width: 60 }} />
      </View>
      <ScrollView contentContainerStyle={styles.scroll}>
        <Text style={styles.body}>Modo demostración de Djangue. Explora las funciones principales sin datos reales.</Text>
      </ScrollView>
      <LegalBar />
    </SafeAreaView>
  );
